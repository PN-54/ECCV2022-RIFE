...
from model_template.IFNet import *
from model_template.IFNet_m import *
import torch.nn.functional as F
from model_template.loss import *
from model_template.laplacian import *
...
class Model:
    ...
    def inference(self, img0, img1, scale=1, scale_list=[4, 2, 1], TTA=False, timestep=0.5):
        ...
        final = self.flownet.num_blocks - 1
        if TTA == False:
            return merged[final]
        else:
            ...
            return (merged[final] + merged2[final].flip(2).flip(3)) / 2
    ...
    def update(self, imgs, gt, learning_rate=0, mul=1, training=True, flow_gt=None):
        ...
        loss_l1 = (self.lap(merged[final], gt)).mean()
