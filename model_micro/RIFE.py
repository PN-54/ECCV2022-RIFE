...
import itertools
from model_micro.warplayer import warp
from torch.nn.parallel import DistributedDataParallel as DDP
from model_micro.IFNet import *
from model_micro.IFNet_m import *
import torch.nn.functional as F
from model_micro.loss import *
from model_micro.laplacian import *
from model_micro.refine import *
...
class Model:
    ...
    def load_model(self, path, device, rank=0):
        ...
        if rank <= 0:
            self.flownet.load_state_dict(torch.load('{}/flownet.pkl'.format(path), map_location=torch.device(device)))
    ...
    def inference(self, img0, img1, scale=1, scale_list=[4, 2, 1], TTA=False, timestep=0.5):
        ...
        if TTA == False:
            ...
            return (merged[0] + merged2[0].flip(2).flip(3)) / 2
