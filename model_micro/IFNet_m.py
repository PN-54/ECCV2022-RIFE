...
class IFBlock(nn.Module):
    def __init__(self, in_planes, c=64, small=False):
...
class IFNet_m(nn.Module):
    ...
    def forward(self, x, scale=[4,2,1], timestep=0.5, returnflow=False):
        ...
        if returnflow:
            ...
            res = tmp[:, :3] * 2 - 1
            merged[0] = torch.clamp(merged[0] + res, 0, 1)
        return flow_list, mask_list[0], merged, flow_teacher, merged_teacher, loss_distill
